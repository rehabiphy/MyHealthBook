...
const styles = StyleSheet.create({
  ...
  sendLabel: { fontFamily: SANS.semibold, fontSize: 14.5, color: C.onPanel },
  trashBtn: { padding: 4 },
  fieldInput: {
    width: '100%',
    borderBottomWidth: 2,
  ...
  helpText: { fontFamily: SANS.regular, fontSize: 14.5, color: C.ink2, lineHeight: 21, marginTop: 12 },
  preview: { fontFamily: MONO.regular, fontSize: 13, lineHeight: 21, color: C.ink2, marginTop: 12 },
});
