...
const styles = StyleSheet.create({
  ...
  condInput: { flex: 1, borderWidth: 1, borderColor: C.hair, borderRadius: 14, paddingVertical: 14, paddingHorizontal: 15, fontFamily: SANS.regular, fontSize: 16, color: C.ink, backgroundColor: 'rgba(255,255,255,0.10)' },
