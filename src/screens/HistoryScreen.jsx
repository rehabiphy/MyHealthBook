...
const styles = StyleSheet.create({
  ...
  dateBtn: { marginTop: 8, borderWidth: 1, borderColor: C.hair, borderRadius: 14, padding: 14, backgroundColor: 'rgba(255,255,255,0.10)' },
  dateBtnLabel: { fontFamily: SANS.regular, fontSize: 16, color: C.ink },
  fieldInput: { width: '100%', marginTop: 8, borderWidth: 1, borderColor: C.hair, borderRadius: 14, paddingVertical: 15, paddingHorizontal: 14, fontFamily: SANS.regular, fontSize: 16, color: C.ink, backgroundColor: 'rgba(255,255,255,0.10)' },
  ...
  searchInput: { width: '100%', marginTop: 12, borderWidth: 1, borderColor: C.hair, borderRadius: 15, paddingVertical: 15, paddingHorizontal: 16, fontFamily: SANS.regular, fontSize: 16, color: C.ink, backgroundColor: 'rgba(255,255,255,0.10)' },
  filterRow: { gap: 7, marginTop: 12, paddingBottom: 4 },
  filterPillWrap: {},
  filterPill: { borderRadius: 999, paddingVertical: 10, paddingHorizontal: 16 },
  filterPillOff: { backgroundColor: 'rgba(255,255,255,0.10)', borderWidth: 1, borderColor: C.hair },
